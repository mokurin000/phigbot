pub const TIPS: [&str;357] = [
  "!!",
  "(Not) Sound Only",
  "(ฅ'ω'ฅ)拿出你的喵爪戳戳歌，没错，你就是最萌的！",
  "(•▴• )咕咕～",
  "00111 11111 01111 11110 11111 11100 01111 11110",
  "1110000 1010000 1110000 100000 1110000 10101000 100000 101010000 10001000 100",
  "2.0啦，大家都长大啦ww",
  "214572406765306542637651 49122908212821240114",
  "34 30 34 38 30",
  ...
  "Note碰到线了就点，什么，还没碰吗？",
  "One! Two! Three! Fire!!!",
  "PigeonGames\\trashbin\\rubbish sorting\\me",
  "Ranking Score 越高，服务费越少喔！",
  "Redemption.",
  ...
  "Tip: Tip: Tip: Tip: Tip: Tip: Tip: Tip: Tip: Tip: Tip: Tip: Tip: Tip: Tip: Tip: Tip: Tip: Tip: Tip: Tip",
  ...
  "— and you —",
  "“闷声发大财”",
  "…这些官方人员天天都在皮什么。不是说好要走高冷一点的路线吗怎么全都喵喵喵、咕咕咕了（啧",
  "← To Be Continued...",
  ...
  "你先别急！！这不有云存档嘛",
  "你啊你，这一点就是好（1 Good.jpg）",
  "你喜欢上面这张曲绘么？",
  "你打一首歌的时间，鸠已经发现 NaN 个问题了",
  "你是想从我这里知道些什么吗？别想了我也什么都不知道",
  ...
  "你能正确的答出滑键可以向哪个方向滑动嘛？——答案是所有方向！",
  "你黄了，你蓝了，你白了，你没了",
  "假如，我是说假如，判定线能够自由地动起来...",
  "像素塔真的存在吗。",
  "兄弟！你好强！",
  "兄弟，鸽子不错，摸摸",
  "其实我们有人提议在tips里面写轻小说（小声）",
  ...
  "如果你现在因为一些事情感到沮丧。那么我就在这里大声为你喊加油。o(｀ω´ )o",
  "如果判定线转起来，人也要转起来（",
  "如果想要挑战自己，可以试一试课题模式？",
  ...
  "彩~虹~课~题~模~式~",
  "快~快~按下这些密密麻麻的按键；你~的~指尖有种不可思议的光线！",
  "快睡觉吧，熬夜对身体不好",
  ...
  "江源速报：PHI集团负责人失踪三日，警方仍在追查中",
  "江源速报：PhigrOS内测开放新节点，完全复原冰封后地表实景",
  ...
  "请多多夸奖画师，虽然不会让你的分数变高，但是画师们会很高兴=￣ω￣=",
  "请给我们的pv组捐点硬盘吧！！非常感谢！",
  ...
  "这里的tips的数量其实很多，有兴趣的朋友可以尝试收集一下。",
  "这鸽子，不要也罢！",
  "进入设置后可以更换头像与名片背景",
  "适度游戏益脑，沉迷游戏伤手。你的双手是为了你的一生服务的,而不是Phigros！",
  "适当的使用器具（例如槌子）可以增加收割的爽感喔！  （请注意设备的寿命，损坏不负赔偿责任）",
  "选中《Random》的时候长按随机按钮有惊喜。",
  "道理我都懂，但这只鸽子为什么那么大？？！",
  "野火烧不尽，春风吹又生",
  "长时间打歌有引发腱鞘炎的风险哦，注意休息。",
  "长音只有1个combo哦，坚持到底拿到Perfect吧！",
  "阿鸠你又在反复看Tips了哦",
  "附近 5 米内，有一只鸽子，正在靠近......",
